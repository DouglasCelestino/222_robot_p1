...
def identifica_amarelo(frame):
    return identifica_cor(frame,(45//2, 50, 50),(75//2, 255, 255))


def identifica_magenta(frame):
    return identifica_cor(frame,(285//2, 50, 50),(330//2, 255, 255))
